...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "The kitchen is the heart of every home, and our modular designs combine style with utility to create efficient and beautiful cooking spaces.",
      features: [
    ...
    },
    {
      ...
      description: "Mass-produced furniture often doesn't fit unique spaces or personal tastes. That's why we offer bespoke furniture solutions that perfectly match your needs.",
      features: [
    ...
    },
    {
      ...
      description: "Interior styling is about transforming a good design into a great one through careful selection and placement of decorative elements.",
      features: [
